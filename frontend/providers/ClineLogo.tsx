 ...
 * Cline bot mark.
 *
 * Path is the official logomark. Do not replace it with a letter or a generic
 * chat bubble.
 */
export function ClineLogo({ size = 32 }: { size?: number }): React.JSX.Element {
  return (
    <svg
      className="cline-logo"
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"

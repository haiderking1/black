...
export const PIERRE_ICON_SPRITE_ID = 'black-pierre-file-icon-sprite'

export const CUSTOM_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="custom-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="custom-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="custom-file-icon-pnpm" viewBox="0 0 32 32">
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet('complete')}${CUSTOM_FILE_ICON_SPRITE}`

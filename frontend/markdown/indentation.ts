...
const INLINE_PARSE_PREFIX = 'black-markdown-inline-prefix:'
 ...
 * code block. In chat output, models frequently generate accidental alignment
 * like `-    text`, which otherwise renders an entire code block for every item.
 * This recovers the intended list content while preserving genuine indented
 * code blocks and explicit code fences.
 */
